...
static const char qt_meta_stringdata_myPlayer[] = {
    "myPlayer\0\0spawn()\0"
};
...
const QMetaObjectExtraData myPlayer::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject myPlayer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_myPlayer,
      qt_meta_data_myPlayer, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &myPlayer::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_myPlayer))
